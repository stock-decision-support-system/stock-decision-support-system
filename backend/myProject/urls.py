...
urlpatterns = [
    ...
    path('investment/default-investment-portfolios-delete/<int:portfolio_id>/', stockViews.delete_investment_portfolio, name='delete-investment-portfolio'),
    path('investment/default-investment-portfolios/<int:portfolio_id>/edit/', stockViews.update_investment_portfolio, name='update-investment-portfolio'),
